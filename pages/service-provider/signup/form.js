...
export default function Form() {
  ...
  const [selector, setSelector] = useState("company");

  const onContinue = () => {
    router.push(`/service-provider/signup/${selector}/profile`);
  };
            ...
            <div className="col-md-12 mt-2 pt-5 mt-sm-5 position-inherit">
              ...
              <div className="row mt-4 mt-sm-4">
                <div className="col-md-4">
                  <div className="form-group radio-input desgin-radio mb-0">
                    <input
                      className="with-gap"
                      type="radio"
                      name="client-selector"
                      id="client1"
                      checked={selector == "company"}
